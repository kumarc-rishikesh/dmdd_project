...
INSERT INTO employee (EMPLOYEE_ID, PHONE_NO, GENDER, DOB, DOJ, TERMINATION_DATE, SALARY, SSN, DEPARTENT_DEPT_ID, EMPLOYEE_NAME) VALUES (EMPLOYEE_ID_SEQ.NEXTVAL, 7778889999, 'Male', TO_DATE('1995-04-10', 'YYYY-MM-DD'), TO_DATE('2023-04-01', 'YYYY-MM-DD'), NULL, 60000, '777-88-9999', 2 ,'Charlie Brown');
INSERT INTO employee (EMPLOYEE_ID, PHONE_NO, GENDER, DOB, DOJ, TERMINATION_DATE, SALARY, SSN, DEPARTENT_DEPT_ID, EMPLOYEE_NAME) VALUES (EMPLOYEE_ID_SEQ.NEXTVAL, 1112223333, 'Female', TO_DATE('1992-12-18', 'YYYY-MM-DD'), TO_DATE('2023-05-01', 'YYYY-MM-DD'), NULL, 65000, '111-22-3333', 1, 'Emily White');
INSERT INTO employee (EMPLOYEE_ID, PHONE_NO, GENDER, DOB, DOJ, TERMINATION_DATE, SALARY, SSN, DEPARTENT_DEPT_ID, EMPLOYEE_NAME) VALUES (EMPLOYEE_ID_SEQ.NEXTVAL, 6667778888, 'Male', TO_DATE('1987-09-05', 'YYYY-MM-DD'), TO_DATE('2023-06-01', 'YYYY-MM-DD'), NULL, 75000, '666-77-8888', 2, 'David Johnson');
INSERT INTO employee (EMPLOYEE_ID, PHONE_NO, GENDER, DOB, DOJ, TERMINATION_DATE, SALARY, SSN, DEPARTENT_DEPT_ID, EMPLOYEE_NAME) VALUES (EMPLOYEE_ID_SEQ.NEXTVAL, 2223334444, 'Female', TO_DATE('1994-06-22', 'YYYY-MM-DD'), TO_DATE('2023-07-01', 'YYYY-MM-DD'), NULL, 80000, '222-33-4444', 3, 'Sophia Miller');
INSERT INTO employee (EMPLOYEE_ID, PHONE_NO, GENDER, DOB, DOJ, TERMINATION_DATE, SALARY, SSN, DEPARTENT_DEPT_ID, EMPLOYEE_NAME) VALUES (EMPLOYEE_ID_SEQ.NEXTVAL, 9990001111, 'Male', TO_DATE('1991-03-12', 'YYYY-MM-DD'), TO_DATE('2023-08-01', 'YYYY-MM-DD'), NULL, 70000, '999-00-1111', 2, 'Ethan Wilson');
INSERT INTO employee (EMPLOYEE_ID, PHONE_NO, GENDER, DOB, DOJ, TERMINATION_DATE, SALARY, SSN, DEPARTENT_DEPT_ID, EMPLOYEE_NAME) VALUES (EMPLOYEE_ID_SEQ.NEXTVAL, 3334445555, 'Female', TO_DATE('1986-10-28', 'YYYY-MM-DD'), TO_DATE('2023-09-01', 'YYYY-MM-DD'), NULL, 85000, '333-44-5555', 1, 'Olivia Davis');
COMMIT;

EXEC raise_service_request(21, 'LUCAS', 'PLUMBING');
EXEC raise_service_request(22, 'MILA', 'GENERAL');
EXEC raise_service_request(23, 'AIDEN', 'HANDYMAN');
EXEC raise_service_request(24, 'RILEY', 'HVAC');
EXEC raise_service_request(25, 'ZARA', 'ELECTRIC');
EXEC raise_service_request(16, 'LIAM', 'PLUMBING');
EXEC raise_service_request(17, 'OLIVIA', 'GENERAL');
EXEC raise_service_request(18, 'NOAH', 'HANDYMAN');
EXEC raise_service_request(19, 'AVA', 'HVAC');
EXEC raise_service_request(20, 'ISABELLA', 'ELECTRIC');
EXEC raise_service_request(21, 'LUCAS', 'PLUMBING');
EXEC raise_service_request(22, 'MILA', 'GENERAL');
EXEC raise_service_request(23, 'AIDEN', 'HANDYMAN');
EXEC raise_service_request(24, 'RILEY', 'HVAC');
EXEC raise_service_request(25, 'ZARA', 'ELECTRIC');
EXEC raise_service_request(16, 'LIAM', 'ELECTRIC');
EXEC raise_service_request(17, 'OLIVIA', 'PLUMBING');
EXEC raise_service_request(18, 'NOAH', 'GENERAL');
EXEC raise_service_request(19, 'AVA', 'HANDYMAN');
EXEC raise_service_request(20, 'ISABELLA', 'HVAC');
EXEC raise_service_request(21, 'LUCAS', 'ELEVATOR');
EXEC raise_service_request(22, 'MILA', 'ELECTRIC');
EXEC raise_service_request(23, 'AIDEN', 'PLUMBING');
EXEC raise_service_request(24, 'RILEY', 'GENERAL');
EXEC raise_service_request(25, 'ZARA', 'HANDYMAN');
EXEC raise_service_request(16, 'LIAM', 'HVAC');
EXEC raise_service_request(17, 'OLIVIA', 'ELEVATOR');
EXEC raise_service_request(18, 'NOAH', 'ELECTRIC');
EXEC raise_service_request(19, 'AVA', 'PLUMBING');
EXEC raise_service_request(20, 'ISABELLA', 'GENERAL');
COMMIT;
