...
INSERT INTO LEASE (lease_id, start_date, end_date, room_no, unit_type, rent, rent_status, OWNER_owner_id)
VALUES (LEASE_ID_SEQ.NEXTVAL, TO_DATE('2023-01-15', 'YYYY-MM-DD'), TO_DATE('2022-01-14', 'YYYY-MM-DD'), 149, '2BHK', 1380, 'Paid', 26);
...
INSERT INTO department (DEPT_ID, NAME) VALUES (DEPT_ID_SEQ.NEXTVAL, 'ELECTRIC');
INSERT INTO department (DEPT_ID, NAME) VALUES (DEPT_ID_SEQ.NEXTVAL, 'PLUMBING');
INSERT INTO department (DEPT_ID, NAME) VALUES (DEPT_ID_SEQ.NEXTVAL, 'GENERAL');
INSERT INTO department (DEPT_ID, NAME) VALUES (DEPT_ID_SEQ.NEXTVAL, 'HANDYMAN');
INSERT INTO department (DEPT_ID, NAME) VALUES (DEPT_ID_SEQ.NEXTVAL, 'HVAC');
INSERT INTO department (DEPT_ID, NAME) VALUES (DEPT_ID_SEQ.NEXTVAL, 'ELEVATOR');
COMMIT;

INSERT INTO UTILITY VALUES (UTILITY_ID_SEQ.NEXTVAL, 'ELECTRICITY', 100.00, 'KWH', 150, LAST_DAY(TO_DATE('2023-11-15', 'YYYY-MM-DD')), 1);
INSERT INTO UTILITY VALUES (UTILITY_ID_SEQ.NEXTVAL, 'WATER', 5.00, 'GALLON', 75, LAST_DAY(TO_DATE('2023-11-15', 'YYYY-MM-DD')), 2);
INSERT INTO UTILITY VALUES (UTILITY_ID_SEQ.NEXTVAL, 'GAS', 8.00, 'KG', 50, LAST_DAY(TO_DATE('2023-11-15', 'YYYY-MM-DD')), 3);
INSERT INTO UTILITY VALUES (UTILITY_ID_SEQ.NEXTVAL, 'ELECTRICITY', 100.00, 'KWH', 180, LAST_DAY(TO_DATE('2023-11-15', 'YYYY-MM-DD')), 4);
INSERT INTO UTILITY VALUES (UTILITY_ID_SEQ.NEXTVAL, 'WATER', 5.00, 'GALLON', 90, LAST_DAY(TO_DATE('2023-11-15', 'YYYY-MM-DD')), 5);
INSERT INTO UTILITY VALUES (UTILITY_ID_SEQ.NEXTVAL, 'GAS', 8.00, 'KG', 60, LAST_DAY(TO_DATE('2023-11-15', 'YYYY-MM-DD')), 6);
INSERT INTO UTILITY VALUES (UTILITY_ID_SEQ.NEXTVAL, 'ELECTRICITY', 100.00, 'KWH', 160, LAST_DAY(TO_DATE('2023-11-15', 'YYYY-MM-DD')), 7);
INSERT INTO UTILITY VALUES (UTILITY_ID_SEQ.NEXTVAL, 'WATER', 5.00, 'GALLON', 80, LAST_DAY(TO_DATE('2023-11-15', 'YYYY-MM-DD')), 8);
INSERT INTO UTILITY VALUES (UTILITY_ID_SEQ.NEXTVAL, 'GAS', 8.00, 'KG', 55, LAST_DAY(TO_DATE('2023-11-15', 'YYYY-MM-DD')), 12);
INSERT INTO UTILITY VALUES (UTILITY_ID_SEQ.NEXTVAL, 'ELECTRICITY', 100.00, 'KWH', 200, LAST_DAY(TO_DATE('2023-11-15', 'YYYY-MM-DD')), 16);
INSERT INTO UTILITY VALUES (UTILITY_ID_SEQ.NEXTVAL, 'WATER', 5.00, 'GALLON', 100, LAST_DAY(TO_DATE('2023-11-15', 'YYYY-MM-DD')), 17);
INSERT INTO UTILITY VALUES (UTILITY_ID_SEQ.NEXTVAL, 'GAS', 8.00, 'KG', 70, LAST_DAY(TO_DATE('2023-11-15', 'YYYY-MM-DD')), 18);
INSERT INTO UTILITY VALUES (UTILITY_ID_SEQ.NEXTVAL, 'ELECTRICITY', 100.00, 'KWH', 140, LAST_DAY(TO_DATE('2023-11-15', 'YYYY-MM-DD')), 19);
INSERT INTO UTILITY VALUES (UTILITY_ID_SEQ.NEXTVAL, 'WATER', 5.00, 'GALLON', 60, LAST_DAY(TO_DATE('2023-11-15', 'YYYY-MM-DD')), 20);
INSERT INTO UTILITY VALUES (UTILITY_ID_SEQ.NEXTVAL, 'GAS', 8.00, 'KG', 45, LAST_DAY(TO_DATE('2023-11-15', 'YYYY-MM-DD')), 21);
INSERT INTO UTILITY VALUES (UTILITY_ID_SEQ.NEXTVAL, 'ELECTRICITY', 100.00, 'KWH', 150, LAST_DAY(TO_DATE('2023-11-15', 'YYYY-MM-DD')), 22);
INSERT INTO UTILITY VALUES (UTILITY_ID_SEQ.NEXTVAL, 'WATER', 5.00, 'GALLON', 70, LAST_DAY(TO_DATE('2023-11-15', 'YYYY-MM-DD')), 23);
INSERT INTO UTILITY VALUES (UTILITY_ID_SEQ.NEXTVAL, 'GAS', 8.00, 'KG', 50, LAST_DAY(TO_DATE('2023-11-15', 'YYYY-MM-DD')), 24);
INSERT INTO UTILITY VALUES (UTILITY_ID_SEQ.NEXTVAL, 'ELECTRICITY', 115.00, 'KWH', 170, LAST_DAY(TO_DATE('2023-11-15', 'YYYY-MM-DD')), 25);
COMMIT;

INSERT INTO employee (EMPLOYEE_ID, PHONE_NO, GENDER, DOB, DOJ, TERMINATION_DATE, SALARY, SSN, DEPARTMENT_DEPT_ID, EMPLOYEE_NAME) VALUES (EMPLOYEE_ID_SEQ.NEXTVAL, 1234567890, 'Male', TO_DATE('1990-01-15', 'YYYY-MM-DD'), TO_DATE('2023-01-01', 'YYYY-MM-DD'), NULL, 50000, '123-45-6789', 1, 'John Doe');
INSERT INTO employee (EMPLOYEE_ID, PHONE_NO, GENDER, DOB, DOJ, TERMINATION_DATE, SALARY, SSN, DEPARTMENT_DEPT_ID, EMPLOYEE_NAME) VALUES (EMPLOYEE_ID_SEQ.NEXTVAL, 9876543210, 'Female', TO_DATE('1985-05-20', 'YYYY-MM-DD'), TO_DATE('2023-01-15', 'YYYY-MM-DD'), NULL, 60000, '987-65-4321', 1, 'Jane Smith');
INSERT INTO employee (EMPLOYEE_ID, PHONE_NO, GENDER, DOB, DOJ, TERMINATION_DATE, SALARY, SSN, DEPARTMENT_DEPT_ID, EMPLOYEE_NAME) VALUES (EMPLOYEE_ID_SEQ.NEXTVAL, 5551112222, 'Male', TO_DATE('1993-11-08', 'YYYY-MM-DD'), TO_DATE('2023-02-01', 'YYYY-MM-DD'), NULL, 55000, '555-11-2222', 2, 'Bob Johnson');
INSERT INTO employee (EMPLOYEE_ID, PHONE_NO, GENDER, DOB, DOJ, TERMINATION_DATE, SALARY, SSN, DEPARTMENT_DEPT_ID, EMPLOYEE_NAME) VALUES (EMPLOYEE_ID_SEQ.NEXTVAL, 4445556666, 'Female', TO_DATE('1988-08-25', 'YYYY-MM-DD'), TO_DATE('2023-03-01', 'YYYY-MM-DD'), NULL, 70000, '444-55-6666', 3, 'Alice Johnson');
INSERT INTO employee (EMPLOYEE_ID, PHONE_NO, GENDER, DOB, DOJ, TERMINATION_DATE, SALARY, SSN, DEPARTMENT_DEPT_ID, EMPLOYEE_NAME) VALUES (EMPLOYEE_ID_SEQ.NEXTVAL, 7778889999, 'Male', TO_DATE('1995-04-10', 'YYYY-MM-DD'), TO_DATE('2023-04-01', 'YYYY-MM-DD'), NULL, 60000, '777-88-9999', 3 ,'Charlie Brown');
INSERT INTO employee (EMPLOYEE_ID, PHONE_NO, GENDER, DOB, DOJ, TERMINATION_DATE, SALARY, SSN, DEPARTMENT_DEPT_ID, EMPLOYEE_NAME) VALUES (EMPLOYEE_ID_SEQ.NEXTVAL, 1112223333, 'Female', TO_DATE('1992-12-18', 'YYYY-MM-DD'), TO_DATE('2023-05-01', 'YYYY-MM-DD'), NULL, 65000, '111-22-3333', 4, 'Emily White');
INSERT INTO employee (EMPLOYEE_ID, PHONE_NO, GENDER, DOB, DOJ, TERMINATION_DATE, SALARY, SSN, DEPARTMENT_DEPT_ID, EMPLOYEE_NAME) VALUES (EMPLOYEE_ID_SEQ.NEXTVAL, 6667778888, 'Male', TO_DATE('1987-09-05', 'YYYY-MM-DD'), TO_DATE('2023-06-01', 'YYYY-MM-DD'), NULL, 75000, '666-77-8888', 4, 'David Johnson');
INSERT INTO employee (EMPLOYEE_ID, PHONE_NO, GENDER, DOB, DOJ, TERMINATION_DATE, SALARY, SSN, DEPARTMENT_DEPT_ID, EMPLOYEE_NAME) VALUES (EMPLOYEE_ID_SEQ.NEXTVAL, 2223334444, 'Female', TO_DATE('1994-06-22', 'YYYY-MM-DD'), TO_DATE('2023-07-01', 'YYYY-MM-DD'), NULL, 80000, '222-33-4444', 5, 'Sophia Miller');
INSERT INTO employee (EMPLOYEE_ID, PHONE_NO, GENDER, DOB, DOJ, TERMINATION_DATE, SALARY, SSN, DEPARTMENT_DEPT_ID, EMPLOYEE_NAME) VALUES (EMPLOYEE_ID_SEQ.NEXTVAL, 9990001111, 'Male', TO_DATE('1991-03-12', 'YYYY-MM-DD'), TO_DATE('2023-08-01', 'YYYY-MM-DD'), NULL, 70000, '999-00-1111', 5, 'Ethan Wilson');
INSERT INTO employee (EMPLOYEE_ID, PHONE_NO, GENDER, DOB, DOJ, TERMINATION_DATE, SALARY, SSN, DEPARTMENT_DEPT_ID, EMPLOYEE_NAME) VALUES (EMPLOYEE_ID_SEQ.NEXTVAL, 3334445555, 'Female', TO_DATE('1986-10-28', 'YYYY-MM-DD'), TO_DATE('2023-09-01', 'YYYY-MM-DD'), NULL, 85000, '333-44-5555', 6, 'Olivia Davis');
INSERT INTO employee (EMPLOYEE_ID, PHONE_NO, GENDER, DOB, DOJ, TERMINATION_DATE, SALARY, SSN, DEPARTMENT_DEPT_ID, EMPLOYEE_NAME) VALUES (EMPLOYEE_ID_SEQ.NEXTVAL, 3334445574, 'Male', TO_DATE('1986-10-28', 'YYYY-MM-DD'), TO_DATE('2023-09-01', 'YYYY-MM-DD'), NULL, 85025, '373-74-5555', 6, 'John Wick');
COMMIT;
